INSTRUCTIONSCONTROLLER = function (ExpCont, WorldState, Stimuli) {
    ...
    this.show_single_sitting_page = function () {
        ...
        console.log(FullScreenTextElem)
    ...
    this.initialize_hint_and_search_phase_general_instructions = function (current_block_num, Fennimals_in_phase_Array, hint_type, close_button_pos) {
        ...
        switch (hint_type) {
            case("location"):
                hint_type_text = " instructed to visit a location where a Fennimal was recently spotted";
                next_hint_text = "instructed which location to visit next";
                break
            case("icon"):
                hint_type_text = " shown the photo of which Fennimal to visit next";
                next_hint_text = "shown the photo of the next Fennimal to visit";
                break
            case("name"):
    ...
    //////////////////////////////////////
    let ExpPaymentData, PaymentCardContainer, AllCardsOnScreen, payment_card_width = 0.2 * GenParam.SVG_width,
