...
let StimulusSettings = function () {
    ...
    const All_Fennimal_Sets = {
        ...
        mentalizing_network: [
            ...
            {id: "P1", head: "E", region: "D", toy: "E", toybox: "A"},
            {id: "P2", head: "F", region: "E", toy: "F", toybox: "B"},
            {id: "P3", head: "A", region: "F", toy: "G", toybox: "C"},
            {id: "P4", head: "B", region: "F", toy: "H", toybox: "D"},
    ...
    let All_Experiment_Structures = {
        test: [
            {
                type:"jump_to_trial",
                Fennimal_interaction_type: ["basic_intro_toybox"], // "ask_contents_box", "play_with_toy_passive" // "find_box", "hat_blown_away" "fly_swatting"
...

            {
                type: "pseudoday",
                information: "new_Fennimals_spotted",
                displayed_icons: ["A1", "A2", "A3", "A4", "B", "B2"],
    ...
    const All_Banned_Head_Lists = {
        test: false, // ["chicken", "owl", "bird", "snowman", "elf", "candycane", "witch"],
        mentalizing_1: false,
    }
