...
CARDSORTINGTASK = function (currentdaynum, HostElem, Stimuli, returnfunction, Special_Settings) {
    ...
    let ReservoirForeignElement, ReservoirGroupDiv, ReservoirCardDiv, ReservoirScrollLeft, ReservoirScrollRight,
        CategoryContinueButton, Title, SubTitle, RequestInstructionsButton
    ...
    function initalize_reservoir_elements() {
        ...
        ReservoirScrollLeft.onpointerdown = function () {
            ReservoirCardDiv.scrollLeft -= 100;
            that.check_reservoir_scroll();
            AudioCont.play_sound_effect("button_click")
        }
        ReservoirScrollRight.onpointerdown = function () {
            ReservoirCardDiv.scrollLeft += 100;
            that.check_reservoir_scroll();
            AudioCont.play_sound_effect("button_click")
        }
        ...
        CategoryContinueButton.onpointerdown = function () {
            start_second_stage();
            AudioCont.play_sound_effect("button_click")
        }
...
BoxController = function (ParentElem, GroupingCont, CardParam) {
    ...
    Box_Foreign.onpointerenter = function () {
        foreign_element_active = true
    }
    Box_Foreign.onpointerleave = function () {
        foreign_element_active = false
    }
    ...
    function create_add_box_button() {
        ...
        AddButton.onpointerdown = function () {
            create_new_box();
    ...
    let Box = function (box_number, Cont) {
        ...
        this.remove_card_from_box = function (cardname) {
            Names_of_cards_in_box = Names_of_cards_in_box.filter(function (e) {
                return e !== cardname
            })
            update_placeholder_text()
    ...
    let DraggableBoxesElementsArray = [], ActiveDraggingElem, ActiveDragging_Mouse_Start_Coords,
...
CardController = function (MainSVG, HeadSVG, ReservoirElem, GroupingCont, CardParam) {
    ...
    let card_name, CardDiv, SVG_elem, NameP, SVG_innergroup, HeadSVGElem, current_station_name, CurrentStationElem,
        current_state, that = this, CurrentContainingBox, is_currently_in_box = false, is_fixed_in_place = false
