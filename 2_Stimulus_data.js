let StimulusSettings = function () {
    ...
    let All_Experiment_Structures = {
        ...
        mentalizing: [
            ...
            {
                type: "jump_to_trial",
                interaction_type: ["find_box_extended"],
                Fennimals_encountered: ["S1" , "S2", "S3"],
                partner_behavior: "active",
                hint_type: ["icon", "toybox", "toy"],
                include_Fennefinder: true,
                included_orthogonal_tasks: ["fly_swat", "reach_hat", "find_box"], //
                orthogonal_tasks_possible_after_trial: 3
            },
    ...
    const All_Forced_Head_Lists = {
        ...
        mentalizing: ["rhino", "cupcake", "eagle", "pencil", "tv", "skull", "elephant",  "shark", "blockhead", "parrot", "stocking"],
    };
