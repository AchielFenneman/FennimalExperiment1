...
let StimulusSettings = function () {
    ...
    this.Instructions_at_start = [  "browser_check_and_full_screen_prompt","consent", "single_sitting",  "overview" ] //"browser_check_and_full_screen_prompt","consent",  "overview"      "browser_check_and_full_screen_prompt","consent", "card_sorting_task", "overview"
    ...
    let All_Fennimal_Sets = {
        ...
        test: {
            all: [
                ...
                {id: "D1", head_group: "D", region: "E"},
                {id: "D2", head_group: "D", region: "F"},
                {id: "D3", head_group: "D", region: "G"},
                {id: "D4", head_group: "D", region: "H"},
    ...
    //TODO If set to true, then the four cardinal regions will be selected if there are four or less regions in the experiment.
    this.prefer_cardinal_directions_if_possible = true
            ...
            for (let variable_feature_type in Variable_Features) {
                switch (variable_feature_type) {
                    case("head_group"):
                        ...
                        let requested_groups_by_size = Object.keys(Variable_Features.head_group).sort(function (a, b) {
                            return Variable_Features.head_group[b] - Variable_Features.head_group[a]
                        })
