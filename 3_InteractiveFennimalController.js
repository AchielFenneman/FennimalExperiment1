...
class TrialFactory {
    ...
    static build(interaction_type, FenObj, partner_is_present, returnfunc) {
        ...
        switch (interaction_type) {
            case "fly_swat":
                if (typeof FlySwatTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "FlySwatTrialController");
                }
                return new FlySwatTrialController(FenObj, partner_is_present, returnfunc);

            case "fly_swat_extended":
                if (typeof FlySwatExtendedTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "FlySwatExtendedTrialController");
                }
            ...
            case "find_box":
                if (typeof FindBoxTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "FindBoxTrialController");
                }
                return new FindBoxTrialController(FenObj, partner_is_present, returnfunc);

            case "find_box_extended": // <--- ADD THIS
                if (typeof FindBoxExtendedTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "FindBoxExtendedTrialController");
                }
            ...
            case "box_room":
                if (typeof BoxRoomTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "BoxRoomTrialController");
                }
                return new BoxRoomTrialController(FenObj, partner_is_present, returnfunc);

            case "partner_belief_in_situ":
                if (typeof PartnerBeliefInSituTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "PartnerBeliefInSituTrialController");
                }
            ...
            case "scan_box_in_situ":
                if (typeof ScanBoxHomeTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "ScanBoxHomeTrialController");
                }
                return new ScanBoxHomeTrialController(FenObj, partner_is_present, returnfunc);

            case "check_box_contents":
                if (typeof CheckBoxContentsTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "CheckBoxContentsTrialController");
                }
                return new CheckBoxContentsTrialController(FenObj, partner_is_present, returnfunc);

            case "feed_Fennimal":
                if (typeof FeedFennimalTrialController === "undefined") {
            ...
            case "broken_toy_in_box":
                if (typeof BrokenToyInBoxTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "BrokenToyInBoxTrialController");
                }
            ...
            case "dirty_toy":
                if (typeof DirtyToyTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "DirtyToyTrialController");
                }
                return new DirtyToyTrialController(FenObj, partner_is_present, returnfunc);

            case "dirty_and_broken_toy":
                if (typeof DirtyAndBrokenToyTrialController === "undefined") {
                    return TrialFactory.missingArchived(interaction_type, "DirtyAndBrokenToyTrialController");
                }
